...
```{r time_series_and_hist, warning=FALSE, echo = FALSE,fig.align='center', fig.height=4, fig.width=10, out.width="100%"}
# import data
...
```{r seasonality irregularities, echo = FALSE, fig.align='center', fig.height=4, fig.width=10, out.width="100%"}
...
```{r log_transformed, echo = FALSE,fig.align='center', fig.height=3, fig.width=7, out.width="100%"}
# Log transformation
